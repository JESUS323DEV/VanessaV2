                ...
                {GALLERY_IMAGES.map((src, i) => (
                    <span
                        ...
                        className={`h-1.5 w-1.5 rounded-full transition-colors ${
                            i === index ? "bg-principal" : "bg-white/60"
                        }`}
                    />
                ))}
            </div>
...
export default function AboutMe() {
    ...
    return (
        ...
        >
            ...
            <a
                href="/#services"
                className="mt-8 flex items-center justify-center gap-2 rounded-full bg-principal px-6 py-3 font-medium text-neutral-900 transition hover:brightness-95"
            >
